...
#define CUSTOM_MACHINE_NAME "JJJ Kossel"
...
//    #define DELTA_DIAGONAL_ROD 271.5 // mm
    #define DELTA_DIAGONAL_ROD 269.80 //JJJ
...
//    #define DELTA_RADIUS (DELTA_SMOOTH_ROD_OFFSET-(DELTA_EFFECTOR_OFFSET)-(DELTA_CARRIAGE_OFFSET))  //mm  Get this value from auto calibrate
    #define DELTA_RADIUS 129.87  //JJJ
  #else
    // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  ...
  #define DELTA_HEIGHT 277.52 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.32, -0.33 } // get these from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 419.69 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define DELAY_BEFORE_PROBING 50  //JJJ // (ms) To prevent vibrations from triggering piezo sensors
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0     // Y offset: -front +behind [the nozzle]
  ...
  #elif ANYCUBIC_PROBE_VERSION == 3  //JJJ piezo probe
    #define Z_PROBE_OFFSET_FROM_EXTRUDER 0 // Z offset: -below +above  [the nozzle]
#else
...
#define Z_CLEARANCE_BETWEEN_PROBES 5 //JJJ def:25 // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE    3 //JJJ def:25 // Z Clearance between multiple probes
...
#define HOMING_FEEDRATE_Z  (40*60) //JJJ
...
//
#define M100_FREE_MEMORY_WATCHER //JJJ    // Add M100 (Free Memory Watcher) to debug memory usage
...
//
//#define REPRAP_DISCOUNT_SMART_CONTROLLER //JJJ
