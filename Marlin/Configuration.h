...
#define STRING_CONFIG_H_AUTHOR "JJJ" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JJJ Delta"
...
//  #define DELTA_SEGMENTS_PER_SECOND 400 //WTF JJJ SERIOUSLY (anycubic exemple : 80)
  #define DELTA_SEGMENTS_PER_SECOND 100 //JJJ
  ...
  #define DELTA_DIAGONAL_ROD 270.1 //271.5 // mm

  // height from z=0 to home position
  #define DELTA_HEIGHT 276.10 // get this value from auto calibrate

//  #define DELTA_ENDSTOP_ADJ { -1.08, -1.38, 0.0 } // get these from auto calibrate
  #define DELTA_ENDSTOP_ADJ { -0.63, -0.55, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
//  #define DELTA_RADIUS 133.5 //mm  Get this value from auto calibrate
  #define DELTA_RADIUS 114.81 //130.89 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
//  #define DELTA_TOWER_ANGLE_TRIM { 0.03, 0.10, -0.13 } // get these values from auto calibrate
  #define DELTA_TOWER_ANGLE_TRIM { 0.34, -0.13, -0.21 } // get these values from auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 142 }
...
#define MIN_PROBE_EDGE 30 //JJJ

// X and Y axis travel speed (mm/m) between probes
//#define XY_PROBE_SPEED (20*60)
//#define XY_PROBE_SPEED (30*60) //last JJJ
#define XY_PROBE_SPEED (80*60) //JJJ

// Feedrate (mm/m) for the first approach when double-probing (MULTIPLE_PROBING == 2)
//#define Z_PROBE_SPEED_FAST HOMING_FEEDRATE_Z
//#define Z_PROBE_SPEED_FAST (8*60)    //PrecisionPiezo
#define Z_PROBE_SPEED_FAST (15*60)    //PrecisionPiezo
...
//  #define MESH_INSET 1              // Set Mesh bounds as an inset region of the bed
  #define MESH_INSET 55 //20              // Set Mesh bounds as an inset region of the bed
//  #define GRID_MAX_POINTS_X 10      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_X 6 //JJJ      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 50), (Y_MAX_POS - 50), 200 }
  #define NOZZLE_PARK_XY_FEEDRATE 70   // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE 70      // Z axis feedrate in mm/s (not used for delta printers)
#endif
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { -50, -98, 0.25}
  #define NOZZLE_CLEAN_END_POINT   { 50, -98, 0.25}
  ...
  #define NOZZLE_CLEAN_CIRCLE_MIDDLE { 0, -85, 0.25} //NOZZLE_CLEAN_START_POINT
