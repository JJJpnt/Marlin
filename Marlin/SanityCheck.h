...
#elif ENABLED(PRINTER_EVENT_LEDS) && DISABLED(BLINKM) && DISABLED(PCA9632) && DISABLED(NEOPIXEL_LED) && DISABLED(JJJRGBW) //JJJ JJJRGBW sanity check
//  #error "PRINTER_EVENT_LEDS requires BLINKM, PCA9632, RGB_LED, RGBW_LED or NEOPIXEL_LED."
  #error "PRINTER_EVENT_LEDS requires JJJRGBW, BLINKM, PCA9632, RGB_LED, RGBW_LED or NEOPIXEL_LED."
#endif
