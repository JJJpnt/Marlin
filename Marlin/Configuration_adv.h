...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {50*60, 50*60, 50*60, 5*60} // Feedrates for manual moves along X, Y, Z, E from panel
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.45  //0.22  // Unit: mm compression per 1mm/s extruder speed
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
// #define MINIMUM_STEPPER_PULSE 0 //JJJ
 #define MINIMUM_STEPPER_PULSE 1 //JJJ
